 ...
 * Sales Return Model
 * 
 * Represents products returned by customers to the warehouse.
 * Returns add stock back and create financial adjustments.
 */
class SalesReturn extends Model
{
    ...
    /**
     * Refund methods (same as Payment methods)
     */
    ...
    protected function casts(): array
    {
        return [
            ...
            'customer_credit_amount' => 'decimal:2',
        ];
    }
    ...
    {
        return $this->hasMany(CustomerLedger::class, 'sales_return_id');
    }
    ...
    /**
     * Get credit amount (alias for customer_credit_amount)
     */
