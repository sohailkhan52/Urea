...
class UdharHistoryService
{
    ...
    public function recordSaleCreated(Sale $sale, ?int $userId = null): UdharHistory
    {
        ...
        return UdharHistory::create([
            ...
            'notes' => "Sale total: Rs. {$sale->total_amount}. Account: " . ucfirst($sale->udhar_account_type),
            'payment_method' => null,
    ...
    public function recordPaymentReceived(
        ...
        return UdharHistory::create([
            ...
            'notes' => $payment->notes . " | Account: " . ucfirst($sale->udhar_account_type),
    ...
    ): UdharHistory
    {
        ...
        return UdharHistory::create([
            ...
            'notes' => "Return amount: Rs. {$returnAmount} adjusted from udhar/created as credit. Account: " . ucfirst($sale->udhar_account_type),
