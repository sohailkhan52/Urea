...
('2026_08_25_000002_create_sales_returns_table', (SELECT MAX(batch) + 1 FROM (SELECT MAX(batch) as batch FROM migrations) as t)),
('2026_08_25_000003_create_sales_return_items_table', (SELECT MAX(batch) + 1 FROM (SELECT MAX(batch) as batch FROM migrations) as t));
