<?php
// Simple direct database connection and table creation
...
try {
    ...
    if ($result->num_rows > 0) {
        ...
        if ($conn->query($sql) === TRUE) {
            echo "✓ sales_returns table created\n";
        } else {
    ...
    // Check if sales_return_items table exists
    ...
    if ($result->num_rows > 0) {
        ...
        if ($conn->query($sql) === TRUE) {
            echo "✓ sales_return_items table created\n";
        } else {
            echo "✗ Error: " . $conn->error . "\n";
            exit(1);
        }
    ...
    echo "The Sales Return form should now work correctly.\n";
