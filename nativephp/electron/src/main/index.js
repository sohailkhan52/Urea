...
const configuredPhpRuntime = import.meta.env.MAIN_VITE_NATIVEPHP_PHP_RUNTIME_PATH;
const phpBinary = configuredPhpRuntime || path.join(buildPath, 'php', executable);
