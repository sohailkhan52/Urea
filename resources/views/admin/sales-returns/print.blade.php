    ...
    <div class="invoice-container">
        ...
        <div class="invoice-meta">
            <div class="meta-section">
                ...
                <p><strong>Original Invoice:</strong> {{ $return->sale->invoice_number }}</p>
            </div>

            <div class="meta-section">
                <h6>Customer Details</h6>
                <p><strong>{{ $return->customer->name }}</strong></p>
                @if($return->customer->company_name)
                    <p>{{ $return->customer->company_name }}</p>
                @endif
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @if($item->reason)
                        <br><small style="color: #0d6efd;">Reason: {{ $item->reason }}</small>
                        @endif
                    </td>
        ...
        <table class="summary-table">
            ...
            <tr>
                ...
                <td class="summary-value" style="color: #0d6efd;">- Rs. {{ number_format($return->discount_amount, 2) }}</td>
            </tr>
            @endif
            <tr class="total-row">
        ...
        <div class="settlement-box">
            ...
            <table class="settlement-table">
                <tr>
                    <td style="width: 50%; color: #666;">Refund to Customer:</td>
                    <td class="text-end" style="font-weight: bold; color: #198754;">Rs. {{ number_format($return->refund_amount ?? 0, 2) }}</td>
                </tr>
                <tr>
                    <td style="width: 50%; color: #666;">Customer Credit Applied:</td>
                    <td class="text-end" style="font-weight: bold; color: #0d6efd;">Rs. {{ number_format($return->credit_amount ?? 0, 2) }}</td>
                </tr>
        ...
        <div style="margin-top: 30px; padding: 15px; background-color: #f8f9fa; border-left: 4px solid #0d6efd;">
            @if($return->reason)
