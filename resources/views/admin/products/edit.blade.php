        ...
        <div class="row">
            <div class="col-lg-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       id="bag_weight" 
                                       name="bag_weight" 
                                       value="{{ old('bag_weight', $product->bag_weight) }}"
                                       step="0.01"
                                       min="0.01"
                                       required>
                                @error('bag_weight')
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('weight_unit') is-invalid @enderror" 
                                    ...
                                    <option value="{{ $key }}" {{ old('weight_unit', $product->weight_unit) === $key ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                    @endforeach
                                </select>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-info">
                            ...
                            <strong>Note:</strong> Current stock: <strong>{{ $product->getCurrentStock() }} bags</strong> (calculated from warehouse inventory)
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-danger">
                    ...
                    <div class="card-body">
                        <p class="mb-3">
                            <strong>Delete Product:</strong> Once deleted, this action cannot be undone.
                        </p>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">
                                Max 2MB. JPG, PNG, GIF
                                @if($product->image)
                                    <br><span class="text-muted">Leave empty to keep current image</span>
                                @endif
                            </div>
                        </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <dl class="row mb-0 small">
                            ...
                            <dd class="col-sm-8">{{ $product->updated_at->format('M d, Y') }}</dd>
